...
export const en: TranslationMap = {
  ...
  subtitles: {
    ...
    review: "Score agent events and approve queued decisions.",
  ...
  review: {
    title: "Review",
    subtitle: "Score autonomous actions and approve queued decisions without popups.",
    pendingApprovals: "Pending approvals",
    pendingApprovalsSubtitle: "Inline approval cards from the gateway queue.",
    projectionCards: "Projection review",
    projectionCardsSubtitle: "Cards from the projection-agent review queue.",
    scoring: "Scoring",
    scoringSubtitle: "Recent OpenClaw events for light calibration.",
    noApprovals: "No pending approvals.",
    noProjectionCards: "No projection review cards.",
    projectionUnavailable: "Projection review queue is not connected.",
    noEvents: "No event cards yet.",
    refresh: "Refresh",
    ...
    deny: "Deny",
    commentPlaceholder: "Optional comment for future calibration...",
    eventSource: "Source",
    eventMode: "Mode",
    eventLevel: "Level",
    eventScore: "Score",
    ...
    feedbackActions: {
      ...
      promoteResearch: "Research brief",
      experimentNext: "Small experiment",
      continueDirection: "Continue",
      tooFar: "Too far",
    },
  },
  logsView: {
