...
export class OpenClawApp extends LitElement {
  ...
  @state() projectionReviewResult:
    | import("./controllers/projection-review.js").ProjectionReviewListResult
    | null = null;
  @state() projectionReviewError: string | null = null;
  @state() reviewCommentDrafts: Record<string, string> = {};
  @state() reviewFeedbackBusyId: string | null = null;
  @state() reviewFeedbackMessage: { kind: "success" | "error"; text: string } | null = null;
